...
@router.get("/", response_model=List[Cards1Out], dependencies=[Depends(ip_rate_limiter)])
...
@router.get("/{item_id}", response_model=Cards1Out, dependencies=[Depends(ip_rate_limiter)])
