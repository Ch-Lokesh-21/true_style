...
async def create_item(
    ...
    Args:
        category: Category name for grouping hero images.
...
@router.get("/", response_model=List[HeroImagesOut], dependencies=[Depends(ip_rate_limiter)])
...
@router.get("/{item_id}", response_model=HeroImagesOut, dependencies=[Depends(ip_rate_limiter)])
