...
import { useCards1 } from '../hooks/useHomeContent';

export const Cards1Section = () => {
  const { data: cards, isLoading } = useCards1();
    ...
    return (
      <Box sx={{ py: 8 }}>
        <Container maxWidth="xl">
          <Skeleton variant="text" width={350} height={50} sx={{ mx: 'auto', mb: 5 }} />
